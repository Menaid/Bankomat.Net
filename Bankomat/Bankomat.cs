...
public class Bankomat
{
    ...
    {
        // Borde göra en check om där finns ett kort redan så att man ej kan sätta in flera kort samtidigt. Return true eller fals om man satt in kortet eller ej
        cardInserted = true;
        this.card = card;
    ...
    {
        // Borde göra en check om där finns ett kort redan så att man ej kan sätta in flera kort samtidigt. Return true eller fals om man satt in kortet eller ej
        card = null; // Ta bort det interna kortet (nolla värdena/spara ej)
        cardInserted = false;
    ...
    {
        // Lägga till checks om där finns kort eller ej
        // Lägga till check om det är rätt pin eller ej
        // Sedan fortsätta med koden.
